 ...
 * @author trevo
 */
public class Juegospc extends javax.swing.JFrame {
    ...
    public Juegospc() {
        ...
        ImageIcon(this.getClass().getResource("/Iconos/pc.jpg")); JLabel fondo= new JLabel();
        fondo.setIcon(uno); getLayeredPane().add(fondo,JLayeredPane.FRAME_CONTENT_LAYER);
        fondo.setBounds(0,0,uno.getIconWidth(),uno.getIconHeight());
    }

    public void CargarJuegospc(){
        
        DefaultTableModel modelo = (DefaultTableModel) jTable1.getModel();
        modelo.setRowCount(0);
        res = Conexiones.Conexion.Consulta("select * from juegospc");
        try{
            while(res.next()){
                Vector v = new Vector();
                v.add(res.getInt(1));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("       LISTA DE JUEGOS PC");
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        ...
        if(jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty() || jTextField4.getText().isEmpty()){
            ...
            try {
                res = Conexiones.Conexion.Consulta("Select COUNT(nombre)from juegospc where nombre='" + jTextField2.getText() + "'");
                try{
                    while(res.next()){
                        cont = res.getInt(1);
                    }
                ...
                if(cont >= 1){
                    ...
                    Procedimientos.EntradaJuegospc(jTextField2.getText(), jTextField3.getText(), jTextField4.getText());
                    jTextField2.setText("");
                    jTextField3.setText("");
                    jTextField4.setText("");
                    jTextField2.requestFocus();
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        if(opc == JOptionPane.YES_OPTION){
            try{
                Procedimientos.EliminarJuegospc(Integer.parseInt(jTable1.getValueAt(row, 0).toString()));
            }catch (SQLException e){
            }
        }
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        if(jTextField1.getText().isEmpty()){
            ...
            try {
                String b;
                Procedimientos.BuscarJuegospc(Integer.parseInt(jTextField1.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Juegospc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
