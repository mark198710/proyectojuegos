 ...
 * @author trevo
 */
public class Juegosnintendo3ds extends javax.swing.JFrame {

    static ResultSet res;
    int cont;
    
    public Juegosnintendo3ds() {
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        setTitle("JUEGOS NINTENDO 3DS");
        ...
        ImageIcon(this.getClass().getResource("/Iconos/3ds.jpg")); JLabel fondo= new JLabel();
        fondo.setIcon(uno); getLayeredPane().add(fondo,JLayeredPane.FRAME_CONTENT_LAYER);
        fondo.setBounds(0,0,uno.getIconWidth(),uno.getIconHeight());
    }

    
    public void CargarJuegosnintendo3ds(){
        
        DefaultTableModel modelo = (DefaultTableModel) jTable1.getModel();
        modelo.setRowCount(0);
        res = Conexiones.Conexion.Consulta("select * from juegosnintendo3ds");
        try{
            while(res.next()){
                Vector v = new Vector();
                v.add(res.getInt(1));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LISTA DE JUEGOS NINTENDO 3DS");
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        ...
        if(jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty() || jTextField4.getText().isEmpty()){
            ...
            try {
                res = Conexiones.Conexion.Consulta("Select COUNT(nombre)from juegosnintendo3ds where nombre='" + jTextField2.getText() + "'");
                try{
                    while(res.next()){
                        cont = res.getInt(1);
                    }
                ...
                if(cont >= 1){
                    ...
                    Procedimientos.EntradaJuegosnintendo3ds(jTextField2.getText(), jTextField3.getText(), jTextField4.getText());
                    jTextField2.setText("");
                    jTextField3.setText("");
                    jTextField4.setText("");
                    jTextField2.requestFocus();
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        if(opc == JOptionPane.YES_OPTION){
            try{
                Procedimientos.EliminarJuegosnintendo3ds(Integer.parseInt(jTable1.getValueAt(row, 0).toString()));
            }catch (SQLException e){
            }
        }
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        if(jTextField1.getText().isEmpty()){
            ...
            try {
                String b;
                Procedimientos.BuscarJuegosnintendo3ds(Integer.parseInt(jTextField1.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Juegosnintendo3ds.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Juegosnintendo3ds().setVisible(true);
            }
        });
    }
