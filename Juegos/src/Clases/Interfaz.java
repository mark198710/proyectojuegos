...
public class Interfaz extends javax.swing.JFrame {
    ...
    public Interfaz() {
        ...
        ImageIcon(this.getClass().getResource("/Iconos/portada.jpg")); JLabel fondo= new JLabel();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(Conexiones.Conexion.getstatus()){
            Juegosxbox360 obj = new Juegosxbox360();
            obj.setVisible(true);
        }else{
            JOptionPane.showMessageDialog(null, "USUARIO Y (0)PASSWORD INCORRECTOS","ERROR DE CONEXION",JOptionPane.ERROR_MESSAGE);
            jTextField1.setText("");
